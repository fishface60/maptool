...
Now create the PKCS12 bundle.

```
openssl pkcs12 -export -name MapToolKeyPair -inkey ~/.maptool-rptools/config/private.pem -in ~/.maptool-rptools/config/ca/certs/ca.crt -chain -passout pass:maptool -out ~/.maptool-rptools/config/keystore.p12
```
